...
(function (root, factory) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        if (typeof options.ranges === 'object') {
            for (range in options.ranges) {
                ...
                if (this.dateLimit && maxDate && start.clone().add(
                    this.dateLimit).isAfter(maxDate)) {
        ...
        if (this.singleDatePicker) {
            ...
            this.container.find(
                '.daterangepicker_input input, .daterangepicker_input > i').hide();
            if (this.timePicker) {
        ...
        if (typeof options.ranges !== 'undefined' && this.opens == 'right') {
            this.container.find('.ranges').prependTo(
        ...
        if (this.element.is('input') && !this.singleDatePicker
            ...
            this.element.val(this.startDate.format(this.locale.format)
                + this.locale.separator + this.endDate.format(
                    this.locale.format));
    ...
    DateRangePicker.prototype = {
        ...
        setEndDate: function (endDate) {
            ...
            if (!this.timePicker) {
                this.endDate = this.endDate.add(1, 'd').startOf('day').subtract(
                    1, 'second');
            }
            ...
            if (this.dateLimit && this.startDate.clone().add(
                this.dateLimit).isBefore(this.endDate)) {
        ...
        updateView: function () {
            if (this.timePicker) {
                ...
                if (!this.endDate) {
                    ...
                    this.container.find(
                        '.right .calendar-time select').removeAttr(
            ...
            if (this.endDate) {
                ...
                this.container.find(
                    'input[name="daterangepicker_start"]').addClass('active');
            } else {
                this.container.find(
                    'input[name="daterangepicker_end"]').addClass('active');
                this.container.find(
        ...
        updateMonthsInView: function () {
            ...
            if (this.maxDate && this.linkedCalendars && !this.singleDatePicker
                ...
                this.leftCalendar.month = this.maxDate.clone().date(2).subtract(
                    1, 'month');
            }
        },
            ...
            if (this.timePicker) {
                ...
                if (this.endDate) {
                    ...
                    second = this.timePickerSeconds ? parseInt(
                        this.container.find('.left .secondselect').val(), 10)
                        : 0;
                    ...
                    second = this.timePickerSeconds ? parseInt(
                        this.container.find('.right .secondselect').val(), 10)
                        : 0;
                    if (!this.timePicker24Hour) {
                        var ampm = this.container.find(
        ...
        renderCalendar: function (side) {
            ...
            if (this.showDropdowns) {
                ...
                for (var m = 0; m < 12; m++) {
                    if ((!inMinYear || m >= minDate.month()) && (!inMaxYear || m
                        <= maxDate.month())) {
            ...
            if (this.endDate == null && this.dateLimit) {
                var maxLimit = this.startDate.clone().add(this.dateLimit).endOf(
                    'day');
            ...
            for (var row = 0; row < 6; row++) {
                ...
                for (var col = 0; col < 7; col++) {
                    ...
                    if (this.minDate && calendar[row][col].isBefore(
                        this.minDate, 'day')) {
                    ...
                    if (this.endDate != null && calendar[row][col].format(
                        'YYYY-MM-DD') == this.endDate.format('YYYY-MM-DD')) {
            ...
            this.container.find('.calendar.' + side + ' .calendar-table').html(
                html);
        ...
        renderTimePicker: function (side) {
            ...
            if (this.dateLimit && (!this.maxDate || this.startDate.clone().add(
                this.dateLimit).isAfter(this.maxDate))) {
            ...
            this.container.find(
                '.calendar.' + side + ' .calendar-time div').html(html);
        ...
        updateFormInputs: function () {
            ...
            if (this.container.find('input[name=daterangepicker_start]').is(
                ":focus") || this.container.find(
        ...
        hoverRange: function (e) {
            ...
            if (label == this.locale.customRangeLabel) {
                ...
                this.container.find('input[name=daterangepicker_start]').val(
                    dates[0].format(this.locale.format));
                this.container.find('input[name=daterangepicker_end]').val(
        ...
        hoverDate: function (e) {
            ...
            if (this.endDate && !this.container.find(
                'input[name=daterangepicker_start]').is(":focus")) {
                this.container.find('input[name=daterangepicker_start]').val(
                    date.format(this.locale.format));
            } else if (!this.endDate && !this.container.find(
                'input[name=daterangepicker_end]').is(":focus")) {
                this.container.find('input[name=daterangepicker_end]').val(
                    date.format(this.locale.format));
            }
            ...
            if (!this.endDate) {
                this.container.find('.calendar tbody td').each(
                    function (index, el) {
        ...
        calculateChosenLabel: function () {
            ...
            if (customRange) {
                if (this.showCustomRangeLabel) {
                    this.chosenLabel = this.container.find(
                        '.ranges li:last').addClass('active').html();
                } else {
        ...
        monthOrYearChanged: function (e) {
            ...
            if (!isLeft) {
                if (year < this.startDate.year() || (year
            ...
            if (isLeft) {
                ...
                if (this.linkedCalendars) {
                    this.rightCalendar.month = this.leftCalendar.month.clone().add(
                        1, 'month');
                }
            } else {
                this.rightCalendar.month.month(month).year(year);
                if (this.linkedCalendars) {
                    this.leftCalendar.month = this.rightCalendar.month.clone().subtract(
                        1, 'month');
                }
            }
            this.updateCalendars();
        ...
        timeChanged: function (e) {
            ...
            if (isLeft) {
                ...
                if (this.singleDatePicker) {
                    ...
                    == start.format('YYYY-MM-DD') && this.endDate.isBefore(
                        start)) {
