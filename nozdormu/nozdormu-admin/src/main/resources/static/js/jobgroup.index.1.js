$(function () {
                ...
                success: function (data) {
                    if (data.code == 200) {
                        ...
                        layer.open({
                            title: I18n.system_tips,
                            btn: [I18n.system_ok],
                            content: (data.msg || (I18n.jobgroup_del
                                + I18n.system_fail)),
                            icon: '2'
                        });
                    }
    ...
    $("#jobgroup_list").on('click', '.opt_edit', function () {
        ...
        $("#updateModal .form input[name='addressType'][value='"
            + row.addressType + "']").click();
        // 机器地址
        $("#updateModal .form textarea[name='addressList']").val(
            row.addressList);
