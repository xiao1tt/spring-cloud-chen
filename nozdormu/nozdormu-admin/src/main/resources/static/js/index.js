...
$(function () {
    ...
    freshChartDate(rangesConf[I18n.daterangepicker_ranges_recent_week][0],
        rangesConf[I18n.daterangepicker_ranges_recent_week][1]);
            ...
            success: function (data) {
                if (data.code == 200) {
                    ...
                    layer.open({
                        ...
                        btn: [I18n.system_ok],
                        content: (data.msg
                            || I18n.job_dashboard_report_loaddata_fail),
                        icon: '2'
                    });
                }
            }
