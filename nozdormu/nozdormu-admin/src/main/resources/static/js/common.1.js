$(function () {
    ...
    $('.sidebar-toggle').click(function () {
        ...
        $.cookie('job_adminlte_settings', job_adminlte_settings,
            {expires: 7});	//$.cookie('the_cookie', '', { expires: -1 });
    });
    ...
    $('#updatePwd').on('click', function () {
        $('#updatePwdModal').modal({backdrop: false, keyboard: false}).modal(
            'show');
    });
    var updatePwdModalValidate = $("#updatePwdModal .form").validate({
        ...
        submitHandler: function (form) {
            $.post(base_url + "/user/updatePwd",
                $("#updatePwdModal .form").serialize(),
                function (data, status) {
                    if (data.code == 200) {
                        ...
                        layer.open({
                            icon: '2',
                            content: (data.msg || I18n.change_pwd
                                + I18n.system_fail)
                        });
                    }
                });
