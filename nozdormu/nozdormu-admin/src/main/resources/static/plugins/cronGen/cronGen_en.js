(function ($) {
    ...
    $.fn.extend({
        cronGen: function (options) {
            ...
            var mainDiv = $("<div/>",
                {id: "CronGenMainDiv", style: "width:410px;height:300px;"});
            var topMenu = $("<ul/>",
                {"class": "nav nav-tabs", id: "CronGenTabs"});
            $('<li/>', {'class': 'active'}).html(
                $('<a id="SecondlyTab" href="#Secondly">秒</a>')).appendTo(
                topMenu);
            $('<li/>').html(
                $('<a id="MinutesTab" href="#Minutes">Minute</a>')).appendTo(
                topMenu);
            $('<li/>').html(
                $('<a id="HourlyTab" href="#Hourly">Hour</a>')).appendTo(
                topMenu);
            $('<li/>').html(
                $('<a id="DailyTab" href="#Daily">Day</a>')).appendTo(topMenu);
            $('<li/>').html(
                $('<a id="MonthlyTab" href="#Monthly">Month</a>')).appendTo(
                topMenu);
            $('<li/>').html(
                $('<a id="WeeklyTab" href="#Weekly">Week</a>')).appendTo(
                topMenu);
            $('<li/>').html(
                $('<a id="YearlyTab" href="#Yearly">Year</a>')).appendTo(
                topMenu);
            ...
            $("<input/>", {type: "hidden", id: "secondHidden"}).appendTo(
                secondsTab);
            ...
            $("<input/>", {type: "hidden", id: "minHidden"}).appendTo(
                minutesTab);
            ...
            $("<input/>", {type: "hidden", id: "hourHidden"}).appendTo(
                hourlyTab);
            ...
            $("<input/>", {type: "radio", value: "4", name: "day"}).appendTo(
                daily3);
            $(daily3).append("from");
            $("<input/>", {
                type: "text",
            ...
            $("<input/>", {type: "radio", value: "5", name: "day"}).appendTo(
                daily6);
            ...
            $("<input/>", {type: "radio", value: "6", name: "day"}).appendTo(
                daily7);
            ...
            $("<input/>", {type: "hidden", id: "monthHidden"}).appendTo(
                monthlyTab);
            ...
            $("<input/>", {type: "hidden", id: "weekHidden"}).appendTo(
                weeklyTab);
            ...
            $("<input/>", {type: "hidden", id: "yearHidden"}).appendTo(
                yearlyTab);
    ...
    $.fn.cronGen.tools = {
        ...
        initMonth: function (strVal) {
            ...
            if (strVal == "*") {
                ...
                ary = strVal.split(",");
                for (var i = 0; i < ary.length; i++) {
                    $(".monthList input[value='" + ary[i] + "']").attr(
                        "checked", "checked");
                }
                $.fn.cronGen.tools.initCheckBox("month");
            }
