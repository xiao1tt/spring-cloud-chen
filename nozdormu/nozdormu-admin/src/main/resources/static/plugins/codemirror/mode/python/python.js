...
(function (mod) {
    ...
    var commonBuiltins = ["abs", "all", "any", "bin", "bool", "bytearray",
        "callable", "chr",
    ...
    CodeMirror.defineMode("python", function (conf, parserConf) {
        ...
        var operators = [parserConf.singleOperators, parserConf.doubleOperators,
        ...
        function tokenBaseInner(stream, state) {
            ...
            if (stream.match(stringPrefixes)) {
                var isFmtString = stream.current().toLowerCase().indexOf('f')
                    !== -1;
                if (!isFmtString) {
