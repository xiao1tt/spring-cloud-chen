...
public class JobScheduleHelper {
    ...
    public void start() {
            ...
            public void run() {
                ...
                while (!scheduleThreadToStop) {
                    ...
                    try {
                        ...
                        List<JobInfo> scheduleList = JobAdminConfig
                                .getAdminConfig().getJobInfoDao()
                        ...
                        if (scheduleList != null && scheduleList.size() > 0) {
                            ...
                            for (JobInfo jobInfo : scheduleList) {
                                ...
                                if (nowTime > jobInfo.getTriggerNextTime() + PRE_READ_MS) {
                                    ...
                                    logger.debug(
                                            " schedule push trigger : jobId = {}", jobInfo.getId());
        ...
        scheduleThread.setName("  admin JobScheduleHelper#scheduleThread");
            ...
            public void run() {
                ...
                while (!ringThreadToStop) {
                    ...
                    try {
                        ...
                        // ring trigger
                        logger.debug(" time-ring beat : " + nowSecond + " = " + Arrays
                                .asList(ringItemData));
    ...
    private void pushTimeRing(int ringSecond, int jobId) {
        ...
        logger.debug(
                " schedule push time-ring : " + ringSecond + " = " + Arrays.asList(ringItemData));
    }
