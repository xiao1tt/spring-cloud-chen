...
public class JobLogReportHelper {
    ...
    public void start() {
        loggerThread = new Thread(() -> {
            ...
            while (!toStop) {
                ...
                try {
                    for (int i = 0; i < 3; i++) {
                        ...
                        Map<String, Object> triggerCountMap = JobAdminConfig
                                .getAdminConfig().getJobLogDao().findLogReport(todayFrom, todayTo);
                        if (triggerCountMap != null && triggerCountMap.size() > 0) {
                            int triggerDayCount = triggerCountMap.containsKey("triggerDayCount") ? Integer
                                    .valueOf(String.valueOf(triggerCountMap.get("triggerDayCount"))) : 0;
                            int triggerDayCountRunning =
                                    triggerCountMap.containsKey("triggerDayCountRunning") ? Integer
                                            .valueOf(String.valueOf(triggerCountMap.get("triggerDayCountRunning")))
                                            : 0;
                            int triggerDayCountSuc = triggerCountMap.containsKey("triggerDayCountSuc") ? Integer
                                    .valueOf(String.valueOf(triggerCountMap.get("triggerDayCountSuc"))) : 0;
                ...
                if (JobAdminConfig.getAdminConfig().getLogretentiondays() > 0
                    ...
                    expiredDay
                            .add(Calendar.DAY_OF_MONTH, -1 * JobAdminConfig.getAdminConfig().getLogretentiondays());
                    ...
                    do {
                        logIds = JobAdminConfig
                                .getAdminConfig().getJobLogDao().findClearLogIds(0, 0, clearBeforeTime, 0, 1000);
        ...
        loggerThread.setName("  admin JobLogReportHelper");
        loggerThread.start();
    }
