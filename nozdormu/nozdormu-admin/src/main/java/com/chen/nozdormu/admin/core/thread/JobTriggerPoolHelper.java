...
import com.chen.nozdormu.admin.core.trigger.JobTrigger;
    ...
    public void start() {
        fastTriggerPool = new ThreadPoolExecutor(
                ...
                new ThreadFactory() {
                    ...
                    public Thread newThread(Runnable r) {
                        return new Thread(r, "  admin JobTriggerPoolHelper-fastTriggerPool-" + r.hashCode());
                    }
                });
        ...
        slowTriggerPool = new ThreadPoolExecutor(
                ...
                new ThreadFactory() {
                    @Override
                    public Thread newThread(Runnable r) {
                        return new Thread(r, "  admin JobTriggerPoolHelper-slowTriggerPool-" + r.hashCode());
                    }
                });
    }
