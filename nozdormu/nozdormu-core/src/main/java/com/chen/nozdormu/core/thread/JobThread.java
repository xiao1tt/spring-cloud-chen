...
import com.chen.nozdormu.core.log.JobLogger;
import com.chen.nozdormu.core.util.ShardingUtil;
        ...
        while (!toStop) {
            ...
            try {
                ...
                if (triggerParam != null) {
                    ...
                    // execute
                    logger.info("job execute start Param:" + triggerParam.getExecutorParams());
                    ...
                    if (triggerParam.getExecutorTimeout() > 0) {
                        ...
                        try {
                            ...
                            logger.info("job execute timeout");
                            JobLogger.log(e);
                    ...
                    if (executeResult == null) {
                        ...
                        executeResult.setMsg(
                                (executeResult != null && executeResult.getMsg() != null
                                        && executeResult.getMsg().length() > 50000)
                                        ? executeResult.getMsg().substring(0, 50000).concat("...")
                                        : executeResult.getMsg());
                        executeResult.setContent(null);
                    }
                    logger.info("job execute end(finish) ReturnT:{}", executeResult);
                ...
                if (toStop) {
                    logger.info("JobThread toStop, stopReason:{}", stopReason);
                }
                ...
                logger.info("job execute error:{}", errorMsg);
            } finally {
                if (triggerParam != null) {
